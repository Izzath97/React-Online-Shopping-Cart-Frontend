        ...
        <div class="container">
          <div class="row">
            <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center">
              <img src="https://images.asos-media.com/products/asos-design-maternity-broderie-mini-dress-with-frill-shoulder-in-wine/13313615-1-wine?$n_480w$&wid=476&fit=constrain" />
              <a
                href=""
            ...
            <div class="col-md-7 py-5 wrap-about pb-md-5 ">
              <div class="heading-section-bold mb-5 mt-md-5">
                <div class="ml-md-0">
                  <h2 class="mb-4" style={{ color: "purple" }}>
                    Brands.lk
                    <br />
                    Online Fashion Shop
                  </h2>
